 ...
 * 	Last Update: Thu 27 Feb 2011 10:59:49 AM PST
 *
...
/**
 * @brief The offset of other addresses.  
 */
...
#define A	((unsigned char) (SEG_TOP_CENTER|SEG_TOP_RIGHT|SEG_MIDDLE|SEG_BOTTOM_RIGHT|SEG_BOTTOM_CENTER|SEG_BOTTOM_LEFT))
#define B	((unsigned char) (SEG_TOP_LEFT|SEG_MIDDLE|SEG_BOTTOM_CENTER|SEG_BOTTOM_RIGHT|SEG_BOTTOM_LEFT))
#define C	((unsigned char) (SEG_TOP_CENTER|SEG_TOP_LEFT|SEG_BOTTOM_CENTER|SEG_BOTTOM_LEFT))
#define D	((unsigned char) (SEG_TOP_RIGHT|SEG_MIDDLE|SEG_BOTTOM_CENTER|SEG_BOTTOM_RIGHT|SEG_BOTTOM_LEFT))
